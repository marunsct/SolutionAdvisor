sap.ui.define([
  ...
  return Controller.extend("sd.solutionadvisor.controller.AdminRealWorldExample", {
    ...
    onFilterChange: function() {
      ...
      if (sObjectType) {
        aFilters.push(new Filter("objectType", FilterOperator.EQ, sObjectType));
      }
      ...
      if (sLevel) {
        aFilters.push(new Filter("cleanCoreLevel", FilterOperator.EQ, sLevel));
      }
